...
void Texture::createTextureImage(VulkanContext& ctx, CommandManager& cmdMgr)
{
    ...
    Buffer::createBuffer(ctx, imageSize, VK_BUFFER_USAGE_TRANSFER_SRC_BIT,
    ...
    createImage(ctx, texWidth, texHeight, VK_FORMAT_R8G8B8A8_SRGB,
                VK_IMAGE_TILING_OPTIMAL,
                VK_IMAGE_USAGE_TRANSFER_DST_BIT | VK_IMAGE_USAGE_SAMPLED_BIT,
                VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT,
                m_textureImage, m_textureImageMemory);

    transitionImageLayout(ctx, cmdMgr, m_textureImage, VK_FORMAT_R8G8B8A8_SRGB,
                          VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL);
    copyBufferToImage(ctx, cmdMgr, stagingBuffer, m_textureImage,
...
void Texture::createTextureSampler(VulkanContext& ctx)
{
    ...
    if (vkCreateSampler(ctx.getDevice(), &samplerInfo, nullptr, &m_textureSampler) != VK_SUCCESS)
...
void Texture::transitionImageLayout(VulkanContext& ctx, CommandManager& cmdMgr,
...
void Texture::copyBufferToImage(VulkanContext& ctx, CommandManager& cmdMgr,
